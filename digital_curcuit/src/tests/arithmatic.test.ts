...
describe("Test Arithmatic: Full-Adder", () => {
  test("Test Full-Adder - Input1: 0, Input2: 0, Input3: 0 must return Sum: 0, Carry: 0", () => {
    expect(Arithmatic.fullAdder(0, 0, 0)).toEqual([0, 0]);
  })

  test("Test Full-Adder - Input1: 0, Input2: 0, Input3: 1 must return Sum: 1, Carry: 0", () => {
    expect(Arithmatic.fullAdder(0, 0, 1)).toEqual([1, 0]);
  })

  test("Test Full-Adder - Input1: 0, Input2: 1, Input3: 0 must return Sum: 1, Carry: 0", () => {
    expect(Arithmatic.fullAdder(0, 1, 0)).toEqual([1, 0]);
  })

  test("Test Full-Adder - Input1: 0, Input2: 1, Input3: 1 must return Sum: 0, Carry: 1", () => {
    expect(Arithmatic.fullAdder(0, 1, 1)).toEqual([0, 1]);
  })

  test("Test Full-Adder - Input1: 1, Input2: 0, Input3: 0 must return Sum: 1, Carry: 0", () => {
    expect(Arithmatic.fullAdder(1, 0, 0)).toEqual([1, 0]);
  })

  test("Test Full-Adder - Input1: 1, Input2: 0, Input3: 1 must return Sum: 0, Carry: 1", () => {
    expect(Arithmatic.fullAdder(1, 0, 1)).toEqual([0, 1]);
  })

  test("Test Full-Adder - Input1: 1, Input2: 1, Input3: 0 must return Sum: 0, Carry: 1", () => {
    expect(Arithmatic.fullAdder(1, 1, 0)).toEqual([0, 1]);
  })

  test("Test Full-Adder - Input1: 1, Input2: 1, Input3: 1 must return Sum: 1, Carry: 1", () => {
    expect(Arithmatic.fullAdder(1, 1, 1)).toEqual([1, 1]);
  })
});
